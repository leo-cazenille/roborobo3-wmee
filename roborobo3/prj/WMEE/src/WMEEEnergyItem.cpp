...
WMEEEnergyItem::WMEEEnergyItem( int __id ) : EnergyItem( __id )
{
    
}

void WMEEEnergyItem::step()
{
    EnergyItem::step();
...
void WMEEEnergyItem::isTouched( int __idAgent )
{
    EnergyItem::isTouched(__idAgent);
}

void WMEEEnergyItem::isWalked( int __idAgent )
{
...
void WMEEEnergyItem::isPushed( int __id, std::tuple<double, double> __speed )
{
    EnergyItem::isPushed(__id,__speed);
}

void WMEEEnergyItem::setRegion( double offset, double range )
{
    _offsetRegion = offset;
    _range = range;
}

void WMEEEnergyItem::relocate()
{
    // * pick new coordinate
